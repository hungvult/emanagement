...
- Chấm công — mở camera, tự động nhận diện, ghi giờ vào/ra (check-in/check-out)
- Xem lịch sử chấm công cá nhân — xem lại giờ vào/ra các ngày trước, số giờ làm
  trong tháng
- Xin nghỉ / báo phép (tùy chọn mở rộng) — gửi yêu cầu nghỉ, xem trạng thái
  duyệt

## Chức năng dành cho quản trị/HR
